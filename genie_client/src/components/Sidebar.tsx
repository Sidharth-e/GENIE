  ...
  return (
    <>
      ...
      <motion.div
        ...
        className={`fixed top-0 left-0 z-30 h-screen overflow-hidden border-r border-gray-100 bg-white md:sticky ${isOpen ? "flex" : "hidden md:flex"
          }`}
      >
        <div className="flex h-full w-80 flex-shrink-0 flex-col overflow-hidden p-5">
      ...
      <button
        onClick={toggle}
        className={`fixed top-4 left-4 z-40 cursor-pointer rounded-md p-2 transition-all duration-300 md:hidden ${isOpen
