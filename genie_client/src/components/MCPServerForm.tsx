...
import { MCPServerType } from "@/lib/database/models/MCPServer";
            ...
            <div>
              ...
              <div className="relative">
                <textarea
                  ...
                  onPaste={handlePaste}
                  className={`focus:ring-ring/40 h-64 w-full rounded-md border p-3 font-mono text-sm transition-colors focus:ring-2 focus:outline-none ${validationError
