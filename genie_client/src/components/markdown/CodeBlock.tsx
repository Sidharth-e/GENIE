...
export const CodeBlock = ({
  ...
  return (
    <div className="relative my-4 overflow-hidden rounded-xl border border-gray-200 bg-gray-50/50 shadow-sm dark:border-gray-800 dark:bg-gray-900/50">
      {/* Header */}
      ...
      {/* Code Content */}
      <div className="overflow-x-auto p-4 bg-[#f8f9fa] dark:bg-[#0d1117]">
        <code
          className={cn(
            "block font-mono text-sm leading-relaxed whitespace-pre-wrap",
            className,
          )}
          {...props}
        >
